 ...
 *  срезает. Базовый тип сервиса specialUse, его фоновый старт держит,
 *  поэтому срез location туннель не ломает. Тип location остаётся только
 *  стартам из UI с выданным разрешением. Плата: SSID на фоне
