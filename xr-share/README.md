...
xr-share sync --invite <invite> --share notes ~/notes

# A one-shot pass for scripts and checks, without the loop:
...
version and the incoming one is written next to it as a whole file:
