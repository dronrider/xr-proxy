...
| XR-024 | Баннер обновления не появляется авто на холодном старте (фоновая проверка ретраит, не травит дедуп) | bug | P2 | [docs/lld/12-android-apk-self-update.md](lld/12-android-apk-self-update.md), `d57ea6c` |
