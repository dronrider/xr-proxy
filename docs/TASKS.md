...
| XR-045 | Остаток XR-039: на холодном кеше (пустой хеш манифеста) синк с выбором может перекачивать уже скачанное (diff сравнивает с пустым хешем). Сделать diff синка по size+mtime когда хеш пуст; опц. отдавать хеш при скачивании для кеширования (мгновенное скачивание холодного файла уже работает) | task | P3 | [xr-core/src/sync.rs](../xr-core/src/sync.rs) |
