...
| [xr-setup/](../xr-setup/) | Идемпотентный установщик (LLD-13, XR-015): каркас шагов check/apply/verify, server-профиль поднимает xr-server и xr-hub на чистом VPS и заканчивает инвайтом; router-профиль в XR-177. |
