...
| [xr-android/app/src/main/res/drawable/ic_notification_stop.xml](../../xr-android/app/src/main/res/drawable/ic_notification_stop.xml) | Новая vector-drawable для action «Отключить» в уведомлении (простой квадрат stop). |
